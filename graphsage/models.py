...
class SampleAndAggregate(GeneralizedModel):
    ...
    def _build(self):
        ...
        self.neg_samples, _, _ = (tf.nn.fixed_unigram_candidate_sampler(
            true_classes=labels,
            num_true=1,
            num_sampled=FLAGS.neg_sample_size, # 20
            unique=False,
            range_max=len(self.degrees), # 14755
            distortion=0.75,
            unigrams=self.degrees.tolist())) # [20]
        ...
        self.outputs1, self.aggregators = self.aggregate(samples1, [self.features], self.dims, num_samples,
                support_sizes1, concat=self.concat, model_size=self.model_size) # [batch_size, 256]
        self.outputs2, _ = self.aggregate(samples2, [self.features], self.dims, num_samples,
                ...
                model_size=self.model_size) # [batch_size, 256]
        ...
        self.neg_outputs, _ = self.aggregate(neg_samples, [self.features], self.dims, num_samples,
                ...
                concat=self.concat, model_size=self.model_size) # [20, 256]
        ...
        self.outputs1 = tf.nn.l2_normalize(self.outputs1, 1) # [batch_size, 256]
        self.outputs2 = tf.nn.l2_normalize(self.outputs2, 1) # [batch_size, 256]
        self.neg_outputs = tf.nn.l2_normalize(self.neg_outputs, 1) # [20, 256]
